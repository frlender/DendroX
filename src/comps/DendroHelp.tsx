...
export default function DendroHelp(){
    return <div className="help-container">
        ...
        <div className="help-row"><button><RxOpenInNewWindow className='d-icon'/></button> : The external link panel. Pass the labels of the leaf nodes to an external app for interpretation. It has three buttons:</div>
